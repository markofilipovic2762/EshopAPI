...
public static class ShipperEndpoints
{
    public static RouteGroupBuilder MapShipperEndpoints(this RouteGroupBuilder group)
    {
        ...
        group.MapGet("/{id:int}", async (int id, IShipperRepository shipperRepository) => await shipperRepository.GetShipperByIdAsync(id));
        ...
        group.MapDelete("/{id:int}", async (int id, IShipperRepository shipperRepository) => await shipperRepository.DeleteShipperAsync(id));
        return group;
    }
}